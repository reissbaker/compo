!function(exports) {
  ...
  ComponentList.prototype.init = function() {
    ...
    each(this._components, function(component) { component.init(); });
  ...
  ComponentList.prototype.destroy = function() {
    ...
    each(this._components, function(component) { component.destroy(); });
    this._initialized = false;
  ...
  // ugh duplication. prob should just use ES5 #forEach.
