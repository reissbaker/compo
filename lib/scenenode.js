!function(exports) {
  ...
  SceneNode.prototype.before = function(delta, x, y, z) {
    ...
    this.components.before(delta, x, y, z);
    this._children.before(delta, x, y, z);
  };

  SceneNode.prototype.update = nodeMethod('update');

  SceneNode.prototype.after = function(delta, x, y, z) {
    Component.prototype.after.call(this);
    this._children.after(delta, x, y, z);
    this.components.after(delta, x, y, z);
  };
  ...
  function nodeMethod(method) {
    return function(delta, x, y, z) {
      this.components[method](delta, x, y, z);
      this._children[method](delta, x, y, z);
    };
  }
