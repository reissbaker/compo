...
declare module 'gamekernel' {
    ...
    import BehaviorSystem = require('__gamekernel/plugin/behavior-system');
    import Behavior = require('__gamekernel/plugin/behavior');
    import util = require('__gamekernel/core/util');
    import Runner = require('__gamekernel/core/runner');
    import Engine = require('__gamekernel/core/engine');
    ...
    import Welder = require('__gamekernel/core/welder');
    var out: {
